                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('Telefone') ? ' is-invalid' : '' }}" name="phone" required>
                        ...
                        <div class="form-group row">
                            <label for="born" class="col-md-4 col-form-label text-md-right">Data De Nascimento</label>

                            <div class="col-md-6">
                                <input id="phone" type="date" class="form-control{{ $errors->has('born') ? ' is-invalid' : '' }}" name="born" required>
                                @if ($errors->has('born'))
                                    <span class="invalid-feedback" role="alert">
